...
export const Creature = ({ gameState, activeDifficulty }: CreatureProps) => {
  ...
  const isJokerReveal = gameState === 'reveal' && activeDifficulty === 'joker';
    ...
    <AnimatePresence>
      ...
      {!isJokerReveal && (
        <motion.div 
          ...
          className="fixed bottom-4 left-4 sm:bottom-8 sm:left-8 z-40 pointer-events-none mix-blend-screen"
        >
          <motion.div
